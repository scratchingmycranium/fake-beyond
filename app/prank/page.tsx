                ...
                <div className="text-center">
                    ...
                    <div className="bg-white p-12 rounded-lg shadow-lg max-w-4xl mx-auto">
                        ...
                        <p className="text-xl text-gray-700 mb-8">
                            This isn't a real Beyond Meat website! It's a prank site designed to trick you.
                        </p>

                        <div className="bg-red-100 border-l-4 border-red-500 p-6 mb-8">
                            <p className="text-red-800 font-medium text-lg">
                                <strong>PRANK ALERT:</strong> This entire website is fake! No matter which menu item you clicked,
                                you were always going to end up here. We got you good! 😄
                            </p>
                        </div>

                        <div className="space-y-6 text-left max-w-2xl mx-auto">
                            <h3 className="text-xl font-bold text-gray-800">What we tricked you with:</h3>
                            <ul className="list-disc list-inside space-y-2 text-gray-600">
                                ...
                                <li><strong>Fake Mission:</strong> Our "mission" was just to prank you</li>
                            ...
                            <div className="mt-6 bg-yellow-100 p-4 rounded">
                                ...
                                <p className="text-yellow-700">
                                    No matter if you clicked "Products", "Where to Buy", or "Our Mission" -
                                    they ALL lead to this same prank page! We had you from the start.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mt-8 text-sm text-gray-500">
                            <p>Hope you enjoyed the prank! 😉</p>
                        </div>
                    </div>
                </div>
            </main>
